...
GPU-accelerated demand forecasting using optional GPU acceleration cuML for high-performance forecasting.
...
Installs optional GPU acceleration cuML for GPU-accelerated forecasting.
...
-  GPU with CUDA (for RAPIDS scripts, optional)
