...
from src.api.services.integrations_stub import get_wms_service
from src.api.services.integrations_stub import get_attendance_service
from src.api.services.integrations_stub import get_iot_service
