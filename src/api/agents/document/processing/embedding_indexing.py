...
try:
    ...
    connections = Collection = CollectionSchema = None
    FieldSchema = DataType = utility = None
...
class EmbeddingIndexingService:
    """
    Stage 4: Embedding & Indexing using sentence-transformers/all-MiniLM-L6-v2 (2048-dim).
