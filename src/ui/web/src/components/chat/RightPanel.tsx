    ...
    >
      ...
      <Box sx={{ flex: 1, overflow: 'auto', p: 2 }}>
        ...
        {(reasoningChain || reasoningSteps) && (
          ...
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon sx={{ color: '#0D9488' }} />}
              sx={{
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <PsychologyIcon sx={{ color: '#0D9488', fontSize: 20 }} />
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ color: '#0D9488' }} />}>
            <Typography sx={{ color: '#ffffff', display: 'flex', alignItems: 'center', gap: 1 }}>
              <TableChartIcon sx={{ color: '#0D9488' }} />
                        ...
                        {itemType === 'procedure' && itemData && (
                          <Box sx={{ mb: 1 }}>
                            ...
                            {itemData.steps && Array.isArray(itemData.steps) && (
                              <Box sx={{ mb: 1 }}>
                                <Typography variant="caption" sx={{ color: '#0D9488', display: 'block', mb: 0.5 }}>
                                  Key Steps:
                                </Typography>
                          ...
                          <LinearProgress
                            ...
                            sx={{
                              ...
                              '& .MuiLinearProgress-bar': {
                                backgroundColor: itemScore >= 0.8 ? '#0D9488' : itemScore >= 0.6 ? '#FF9800' : '#f44336',
                              },
                            }}
                          />
                        )}
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <LinearProgress
                      ...
                      sx={{
                        ...
                        backgroundColor: '#333333',
                        '& .MuiLinearProgress-bar': {
                          backgroundColor: plannerDecision.confidence >= 0.8 ? '#0D9488' : '#FF9800',
                        },
                      }}
                    />
                    <Typography variant="caption" sx={{ color: '#666666' }}>
                  ...
                  <ListItem key={tool.id} sx={{ px: 0 }}>
                    <Card sx={{ width: '100%', backgroundColor: '#0a0a0a', border: '1px solid #333333' }}>
                      <CardContent sx={{ p: 1.5 }}>
                        ...
                        <Typography variant="caption" sx={{ color: '#0D9488', display: 'block', mt: 1 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              <Button
                ...
                sx={{ 
                  color: '#0D9488', 
                  borderColor: '#0D9488',
                  '&:hover': { borderColor: '#0D9488', backgroundColor: 'rgba(13, 148, 136, 0.1)' }
                }}
              >
                Open MCP Panel
              </Button>
