...
const ChatInterfaceNew: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'answer',
      content: 'Hello! I\'m your WarehouseOps AI assistant. How can I help you today?',
      sender: 'assistant',
      timestamp: new Date(),
      route: 'general',
      confidence: 0.95,
  ...
  const connections = {
    nim: true, // LLM inference - assume available if we're using it
              ...
              <FormControlLabel
                ...
                label={
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                    <PsychologyIcon sx={{ fontSize: 18, color: enableReasoning ? '#0D9488' : '#666666' }} />
