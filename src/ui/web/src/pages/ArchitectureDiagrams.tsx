...
const ArchitectureDiagrams: React.FC = () => {
  ...
  const architectureComponents = [
    ...
    },
    {
      ...
      technologies: ["LangGraph", "LLM inference", "MCP Framework", "Python"],
      responsibilities: [
    ...
    },
    {
      ...
      technologies: ["Python", "MCP Tools", "LLM inference", "Custom Logic"],
      responsibilities: [
    ...
    },
    {
      ...
      technologies: ["LLM inference", "Chain-of-Thought", "Multi-Hop", "Scenario Analysis"],
      responsibilities: [
    ...
    {
      name: "Data Layer",
      description: "Hybrid data storage with SQLite and ChromaDB",
      technologies: ["PostgreSQL", "TimescaleDB", "ChromaDB", "Redis", "SQL"],
      responsibilities: [
  ...
  const dataFlowSteps = [
    ...
    },
    {
      ...
      description: "LLM inference classifies user intent and determines routing",
      components: ["LLM inference", "Intent Classifier", "Routing Logic"],
    ...
    },
    {
      ...
      components: ["PostgreSQL", "ChromaDB", "Vector Search", "SQL Queries"],
      details: "System queries both structured (PostgreSQL) and vector (ChromaDB) databases for relevant information"
    },
    {
      step: 8,
    ...
    },
    {
      ...
      description: "LLM inference generates final response",
      components: ["LLM inference", "Response Formatter", "Structured Data"],
  ...
  const systemArchitecture = {
    ...
    description: "High-level view of the WarehouseOps AI architecture showing all major components and their relationships",
    components: [
    ...
    <Box sx={{ p: 3, maxWidth: 1200, mx: 'auto' }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          Comprehensive visual documentation of the WarehouseOps AI architecture, 
                  ...
                  <List dense>
                    ...
                    <ListItem>
                      <ListItemText 
                        ...
                        secondary="Groq Llama 3.3 70B + local MiniLM embeddings"
                      />
                    </ListItem>
                    <ListItem>
                      <ListItemText 
      ...
      <Box sx={{ mt: 4, pt: 3, borderTop: 1, borderColor: 'divider' }}>
        <Typography variant="body2" color="text.secondary" align="center">
          Architecture Diagrams - WarehouseOps AI
        </Typography>
