  ...
  const deploymentEnvironments = [
    {
      ...
      services: ["PostgreSQL", "Redis", "ChromaDB", "LLM inference"],
      status: "✅ Ready"
    },
    {
      name: "Staging",
      ...
      services: ["PostgreSQL", "Redis", "ChromaDB", "LLM inference", "Prometheus", "Grafana"],
      status: "✅ Ready"
    },
    {
      name: "Production",
      ...
      services: ["PostgreSQL Cluster", "Redis Cluster", "ChromaDB Cluster", "LLM inference", "Full Monitoring Stack", "Load Balancer"],
      status: "🔄 In Progress"
    }
  ];
  ...
  const deploymentSteps = [
    {
      ...
      content: [
        ...
        "Set up  GPU drivers (for ChromaDB)",
        "Configure  API keys"
      ]
    },
    {
    ...
    <Box sx={{ p: 3, maxWidth: 1200, mx: 'auto' }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          Comprehensive guide for deploying the WarehouseOps AI across different environments. 
      ...
      <Box sx={{ mt: 4, pt: 3, borderTop: 1, borderColor: 'divider' }}>
        <Typography variant="body2" color="text.secondary" align="center">
          Deployment Guide - WarehouseOps AI
        </Typography>
